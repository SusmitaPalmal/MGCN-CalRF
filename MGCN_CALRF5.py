...
list_content = combinations(files_content, 5)
list_cite=combinations(files_cite, 5)

file1 = open("output_5mod.csv.csv","w")
      ...
      for itr in range (0,1):
            ...
            for train_index,test_index in kf.split(_content_no_subject1,node_label1):
                ...
                #   for modality5=====
                  ...
                  X_train=np.concatenate((train_embd1,train_embd2,train_embd3,train_embd4,train_embd5), axis=1)
                  X_test=np.concatenate((test_embd1,test_embd2,test_embd3,test_embd4,test_embd5), axis=1)
