#Four modalities have been taken here each time for the experiment#
...
list_content = combinations(files_content, 4)
list_cite=combinations(files_cite, 4)

file1 = open("output_4mod.csv.csv","w")
...
for combo_content,combo__cite in zip(list(list_content), list(list_cite)):
      ...
      print("shape modality4=========",DATA_raw_content4.shape)
      DATA_raw_content4.rename(columns={ DATA_raw_content4.columns[0]: "id" }, inplace = True)
      DATA_raw_content4.rename(columns={ DATA_raw_content4.columns[-1]: "subject" }, inplace = True)
      #DATA_raw_content
      DATA_content_str_subject4= DATA_raw_content4.set_index("id")
      DATA_content_no_subject4= DATA_content_str_subject4.drop(columns="subject")

      #print("shape is",DATA_content_no_subject)
      DATA_no_subject4 = StellarGraph({"paper": DATA_content_no_subject4}, {"cites": DATA_cites4})
      G4=DATA_no_subject4
      node_label4= DATA_content_str_subject4["subject"]
      ...
      for itr in range (0,1):
            ...
            for train_index,test_index in kf.split(DATA_content_no_subject1,node_label1):
                ...
                #   for modality4=====
                  ...
                  X_train=np.concatenate((train_embd1,train_embd2,train_embd3,train_embd4), axis=1)
                  X_test=np.concatenate((test_embd1,test_embd2,test_embd3,test_embd4), axis=1)
            ...
            file1.write("\n")
            print("acc ,  Mcc ,  pre ,  sen ,  sp ,  BalAcc,  f1 ")
